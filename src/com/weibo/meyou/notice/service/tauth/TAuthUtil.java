package com.weibo.meyou.notice.service.tauth;
...
import com.weibo.meyou.notice.service.tauth.TAuthStore.TauthToken;
		...
		for(TauthToken tt : list) {
			...
			if (!today.equals(date)) {
				...
				try {
					...
					ret = OpenAPIDataUtils.instance.requestPostUrl(refreshTokenUrl, null, params);
